...
class New extends Component{
  ...
  salvageFunction=()=>{
    ...
    this.setState({salvage: !this.state.salvage })
...
handleOnSubmit=(event)=>{
  ...
  if (this.state.salvage === true)
  {this.getSalvage()}

  if (this.state.history === true)
  {this.getHistory()}
  
  if (this.state.market === true) {
    this.getValue()
  }
...
// CALL TO THE API - data include as example


const specifications = {success: true, specification:{ anti_brake_system: "4-Wheel ABS",city_mileage: "15 - 16 miles/gallon",drive_type: "4WD",engine: "3.5L V6 MPI",fuel_type: "Gasoline",highway_mileage: "18 miles/gallon"
,made_in: "Japan",make: "Nissan",model: "Pathfinder LE / SE",optional_seating: null,overall_height: "70.90 inches",overall_length: "182.70 inches",overall_width: "71.70 inches"
,standard_seating: "5"
,steering_type: "R&P"
,style: "SUV 4D"
,tank_size: null
...
getHistory=()=>{
  ...
  const dataHistory = {
    "historyInformation": [
        {
            ...
            "VehicleIdentification": {
                "IdentificationID": "JN8DR09Y82W703284"
            },
            "VehicleOdometerReadingMeasure": "000104190",
            "TitleIssuingAuthorityName": "IN",
        ...
        },
        {
            ...
            "TitleIssuingAuthorityName": "IN",
            "VehicleOdometerReadingMeasure": "000104141",
            "VehicleOdometerReadingUnitCode": "M",
            "VehicleIdentification": {
                "IdentificationID": "JN8DR09Y82W703284"
            }
        },
        {
            ...
            "VehicleOdometerReadingMeasure": "000053891"
        },
        {
            "VehicleOdometerReadingMeasure": "000030130",
            "TitleIssuingAuthorityName": "IN",
            "VehicleOdometerReadingUnitCode": "M",
            "VehicleIdentification": {
                "IdentificationID": "JN8DR09Y82W703284"
        ...
        {
            "VehicleOdometerReadingMeasure": "000000010",
            "VehicleOdometerReadingUnitCode": "M",
            "TitleIssuingAuthorityName": "NY",
            "VehicleIdentification": {
                "IdentificationID": "JN8DR09Y82W703284"
            },
            "TitleIssueDate": {
    ...
    "currentTitleInformation": [
        {
            "VehicleOdometerReadingMeasure": "000124785",
            "VehicleIdentification": {
                "IdentificationID": "JN8DR09Y82W703284"
            },
            "TitleIssuingAuthorityName": "IN",
  ...
  this.setState({carHistory: dataHistory })
}


 //  --------- MARKETVALUE GET REQUEST -----------
...
getValue=()=>{
  ...
  const dataMarket = {
    ...
    "make": "Nissan",
    "model": "Pathfinder",
    "body": "Utility 4D SE 4WD 3.5L V6",
    "averageMileage": "162500",
    "mileageAdjustment": "0",
    "adjustedCleanTrade": "1550",
    "adjustedAverageTrade": "1100",
    "adjustedRoughTrade": "550",
    "adjustedCleanRetail": "3175",
    "adjustedLoan": "1400",
    "maxMileageAdj": "775",
    "minMileageAdj": "-620",
    "minAdjRetail": "420",
    ...
    "auctionValues": {
        "lowAuctionValue": 600,
        "averageAuctionValue": 1125,
        "highAuctionValue": 1675,
        "dateRange": "03/29/2021 - 04/04/2021"
    }
}

  this.setState({marketValue: dataMarket 
  }) 
  ...
  render(){
      ...
      <div className="wrapper">
        ...
        <div className="inner">
          ...
          <h3>Insert Your Vin number</h3>
                   {/* history of the vehicle */}
            <div className="form-check">
            <input className="form-check-input" type="checkbox" value="" id="Vehicle Background" onChange={this.carHistoryFunction}></input>
                <label className="form-check-label" for="Vehicle Background">
                Vehicle Background
             </label>
            </div>
              ...
              {/* Market Value */}
              <div className="form-check">
            <input className="form-check-input" type="checkbox" value="" id="Market Value" onChange={this.marketValueFunction}></input>
                <label className="form-check-label" for="Market Value">
                Market Value
             </label>
            </div>
            <div className='form-group'>
                <label></label>
                <input type='text' className='form-control' placeholder='Insert your VIN' onChange={e=> this.setState({vinNumber: e.target.value})}/>
            </div>

          <input type="submit" name="submit" value="Let's check that car" className="button"/>
          </form>
          <>{this.state.specifications.success? 
            <>{this.props.history.push({
          pathname: '/report', specifications:this.state.specifications, carHistory:this.state.carHistory, marketValue: this.state.marketValue, market:this.state.market, history:this.state.history, salvage:this.state.salvage, salvageInfo:this.state.salvageInfo, 
          state: "hello"
          })}</>
